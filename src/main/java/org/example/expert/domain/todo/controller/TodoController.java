...
public class TodoController {
    ...
    public ResponseEntity<Page<GetTodoResponseDto>> getTodosWithQuery(
        @RequestParam(defaultValue = "1") int page,
        @RequestParam(defaultValue = "10") int size,
        ...
        return ResponseEntity.ok(todoService.getTodosWithQuery(page, size, title, startTime, nickname));
